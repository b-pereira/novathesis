...
\documentclass[
  docdegree=mscplan,        % phd(*), phdplan, phdprop, msc, mscplan, bsc
...
%\renewcommand*{\glossariescaptionsportuges}{%
...
\printbibheading\printbibliography[section=1,heading=subbibliography]
