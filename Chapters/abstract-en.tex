...
%% Abstract in English
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Set the title in the abstract. If main language english uncomment the
% line with \thetitle  macro. 
% Uncomment the other otherwise
{\large \textbf{\thetitle}}\\[1ex]
% {\large \textbf{ My Title }}\\[1ex]
\noindent The dissertation must contain two versions of the abstract, one in the same language as the main text, another in a different language.  The package assumes that the two languages under consideration are always Portuguese and English.
